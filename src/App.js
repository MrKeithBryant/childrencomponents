      ...
      <div className="col-md-10 col-md-offset-1">
        ...
        <div className="col-md-12">
          <div className="row">
            ...
            {renderFeed.length ? renderFeed : <Loader/>}
          </div>
        </div>
      </div>
    )
...
class App extends Component {
  ...
  componentDidMount() {
  let url = 'https://newsapi.org/v1/articles?source=bbc-news&sortBy=top&apiKey=1e6ead37c8354fdbb481f3a526695679';
...
render() {
  ...
  return (
    <div className="App row">
      ...
      {/* Your code here*/}
      {feed.length ?
        <Feed onClick={this.randomizer} feed={feed} />:
          <Loader/>
      }
    </div>
  );
